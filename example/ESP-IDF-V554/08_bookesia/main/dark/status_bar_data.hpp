...
constexpr StatusBar::AreaData STYLESHEET_240_320_DARK_STATUS_BAR_AREA_DATA(int w_percent, StatusBar::AreaAlign align)
{
    return {
...
constexpr StatusBar::Data STYLESHEET_240_320_DARK_STATUS_BAR_DATA = {
    .main = {
    ...
    .area = {
        ...
        .num = 1,
        .data = {
            STYLESHEET_240_320_DARK_STATUS_BAR_AREA_DATA(100, StatusBar::AreaAlign::CENTER),
        },
    },
