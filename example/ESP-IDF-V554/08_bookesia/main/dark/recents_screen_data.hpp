...
constexpr RecentsScreenSnapshot::Data STYLESHEET_240_320_DARK_RECENTS_SCREEN_SNAPSHOT_DATA = {
...
constexpr RecentsScreen::Data STYLESHEET_240_320_DARK_RECENTS_SCREEN_DATA = {
    .main = {
        .y_start = 0,
    ...
    .snapshot_table = {
        ...
        .snapshot = STYLESHEET_240_320_DARK_RECENTS_SCREEN_SNAPSHOT_DATA,
    },
    .trash_icon = {
        .default_size = gui::StyleSize::SQUARE(40),
        .press_size = gui::StyleSize::SQUARE(40),
